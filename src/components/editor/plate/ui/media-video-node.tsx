...
// Lazily load react-player on client only (cast to any to avoid strict prop typing issues)
const ReactPlayer: any = dynamic(() => import("react-player").then(m => (m as any).default || (m as any)), { ssr: false }) as any;
          ...
          >
            <div className="group/media">
              ...
              {isUpload && isEditorMounted && (
                <div ref={handleRef}>
                  <ReactPlayer url={unsafeUrl as any} height="100%" width="100%" controls />
                </div>
              )}
            </div>
          </Resizable>
