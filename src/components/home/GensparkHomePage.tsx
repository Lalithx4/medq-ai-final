...
export function GensparkHomePage() {
  ...
  const handleSearch = () => {
    ...
    // Route based on selected search mode
            ...
            <div className="flex items-center justify-center gap-3 md:gap-4 flex-wrap px-4">
              {tools.map((tool, i) => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#2a2a2c] border border-gray-700 hover:bg-[#3a3a3c] hover:border-gray-600 transition-all cursor-pointer group"
