...
function SlidePreviewBase({
  ...
  const { items: slides, scrollToSlide } = usePresentationSlides();
                ...
                <div className="h-max max-h-[90vh] overflow-auto">
                  <div className="flex flex-col space-y-3 sm:space-y-4 p-2 sm:p-4">
                    <div className="mb-1 sm:mb-2 flex items-center justify-between">
                      <h2 className="text-xs sm:text-sm font-semibold">Slides</h2>
                      ...
                      >
                        <PanelRightOpen className="h-3 w-3 sm:h-3.5 sm:w-3.5" />
                      </Button>
                    </div>
        ...
        {showSidebar && isSidebarCollapsed && (
          ...
          >
            <button
              ...
              className="rounded-md border border-[var(--presentation-primary)] px-1 py-2 hover:bg-[var(--presentation-primary)]/10 transition-colors"
              aria-label="Show slides preview"
            >
