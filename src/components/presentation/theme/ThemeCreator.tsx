...
export function ThemeCreator({ children }: { children?: ReactNode }) {
  ...
  const form = useForm<ThemeFormValues>({
    defaultValues: {
      ...
      themeBase: "orbit",
      colors: {
        light: { ...themes.orbit.colors.light },
        dark: { ...themes.orbit.colors.dark },
      },
      fonts: { ...themes.orbit.fonts },
      borderRadius: themes.orbit.borderRadius,
      transitions: { ...themes.orbit.transitions },
      shadows: {
        light: { ...themes.orbit.shadows.light },
        dark: { ...themes.orbit.shadows.dark },
      },
    },
  });
