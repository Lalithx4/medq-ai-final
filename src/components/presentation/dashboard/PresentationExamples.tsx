...
export const EXAMPLE_PROMPTS = [
  {
    ...
    icon: "❤️",
    title: "Advanced Techniques in Cardiovascular Surgery",
    slides: 5,
    lang: "en-US",
    style: "professional",
  ...
  },
  {
    ...
    icon: "💉",
    title: "Modern Approaches to Diabetes Management",
    slides: 5,
    lang: "en-US",
    style: "traditional",
  ...
  },
  {
    ...
    icon: "🎗️",
    title: "Immunotherapy in Cancer Treatment",
    slides: 5,
    lang: "en-US",
    style: "default",
  ...
  },
  {
    id: "neurosurgery",
    icon: "🧠",
    title: "Innovations in Neurosurgical Procedures",
    slides: 5,
    lang: "en-US",
    style: "professional",
  ...
  },
  {
    ...
    icon: "💊",
    title: "Combating Antibiotic Resistance in Clinical Practice",
    slides: 5,
    lang: "en-US",
    style: "default",
  ...
  },
  {
    id: "pediatric-care",
    icon: "👶",
    title: "Evidence-Based Pediatric Care Guidelines",
    slides: 5,
    lang: "en-US",
    style: "traditional",
  ...
  },
  {
    ...
    icon: "🚑",
    title: "Critical Care in Emergency Medicine",
    slides: 5,
    lang: "en-US",
    style: "default",
    color: { background: "rgba(239, 68, 68, 0.1)", color: "#EF4444" },
  },
  {
    id: "mental-health",
    icon: "🧘",
    title: "Integrated Approaches to Mental Health Treatment",
    slides: 5,
    lang: "en-US",
    style: "traditional",
  ...
  },
  {
    ...
    icon: "🔬",
    title: "Laparoscopic Surgical Techniques and Outcomes",
    slides: 5,
    lang: "en-US",
    style: "professional",
  ...
  },
  {
    id: "hypertension",
    icon: "🩺",
    title: "Pharmacological Management of Hypertension",
    slides: 5,
    lang: "en-US",
    style: "default",
  ...
  },
  {
    ...
    icon: "🦠",
    title: "Emerging Infectious Diseases and Treatment",
    slides: 5,
    lang: "en-US",
    style: "traditional",
  ...
  },
  {
    ...
    icon: "🫀",
    title: "Organ Transplantation: Advances and Challenges",
    slides: 5,
    lang: "en-US",
    style: "professional",
  ...
  },
  {
    id: "pain-management",
    icon: "💆",
    title: "Multimodal Pain Management Strategies",
    slides: 5,
    lang: "en-US",
    style: "traditional",
  ...
  },
  {
    ...
    icon: "🫁",
    title: "Advances in Respiratory Medicine and Pulmonology",
    slides: 5,
    lang: "en-US",
    style: "default",
