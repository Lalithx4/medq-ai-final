...
// Reduced image sizes to give more space for text content
export const BASE_WIDTH_PERCENTAGE = "25%"; // Reduced from 45% to 25%
export const BASE_HEIGHT = 200; // Reduced from 384 to 200
