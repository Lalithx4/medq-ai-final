      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Upload any PDF to BioDocs AI, ask a question, and get concise, citation-linked answers and summaries in seconds—free tier, 256-bit encrypted, no data training.
          </p>
        </div>
